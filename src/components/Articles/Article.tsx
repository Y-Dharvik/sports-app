    ...
    <div className="flex-auto flex justify-center">
      <div className="max-w-sm rounded overflow-hidden shadow-lg flex-auto">
        ...
        <div className="px-6 py-4">
          ...
          <p className="text-gray-700 text-base">{articlee.summary}</p>
          <br />
          <button
            onClick={() => {
              setOpenRead(true);
          ...
          <Transition show={openRead} as={Fragment}>
            <Dialog
              as="div"
...
//             Read More
//           </button>
//           <Transition show={openRead} as="div">

//             {openRead && (
//               <Dialog
//                 as="div"
//                 className="fixed inset-0 overflow-y-auto flex justify-center items-center bg-black bg-opacity-45"
